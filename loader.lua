...
local UserID = LRM_LinkedDiscordID

local success, response = pcall(function()
    return request({
        Url = "https://dashboard.botghost.com/api/public/tools/user_lookup/"..UserID,
        Method = "GET",
        Headers = {
...
local library = {
    ...
    signal = loadstring(game:HttpGet('https://pastebin.com/raw/f88sZE77'))();
    open = false;
    opening = false;
    hasInit = false;
    cheatname = startupArgs.cheatname or 'rift.cc';
...
library.themes = {
    {
        ...
        theme = {
            ...
            ["Section Background"]        = fromrgb(14, 14, 15);
            ...
            ["Option Background"]         = fromrgb(14, 14, 15);
...
function library:CreateSettingsTab(menu)
    ...
    mainSection:AddToggle({text = 'Keybind Indicator', flag = 'keybind_indicator', state = true, callback = function(bool)
        library.keyIndicator:SetEnabled(bool);
    end})
    mainSection:AddSlider({text = 'Position X', flag = 'keybind_indicator_x', min = 0, max = 100, increment = .1, value = 0.5, callback = function()
    ...
    mainSection:AddSlider({text = 'Position Y', flag = 'keybind_indicator_y', min = 0, max = 100, increment = .1, value = 41.4, callback = function()
        library.keyIndicator:SetPosition(newUDim2(library.flags.keybind_indicator_x / 100, 0, library.flags.keybind_indicator_y / 100, 0));    
    end});
    ...
    library.keyIndicator:SetPosition(newUDim2(0.6 / 100, 0, 48.2 / 100, 0));    
